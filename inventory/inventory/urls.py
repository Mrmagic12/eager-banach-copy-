...
urlpatterns = i18n_patterns(
    ...
    path("@dcf-links/en/admin/cms/page/copy-plugins/", admin.site.urls, name=""),
    path("@dcf-links/en/admin/cms/page/add-plugin/", admin.site.urls),
    path("en/select2/", include("django_select2.urls")),
)
